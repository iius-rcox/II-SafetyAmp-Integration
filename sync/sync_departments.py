...
class DepartmentSyncer(SyncOperation):
    def __init__(self):
        super().__init__(name="sync_departments", sync_type="departments", entity_type="department")
        # Base sets self.api_client and self.viewpoint
    ...
    def perform_sync(self):
        ...
        # This sync doesn't return counts today; return a simple processed metric
        return {"processed": len(self.source_data), "created": 0, "updated": 0, "skipped": 0, "errors": 0}