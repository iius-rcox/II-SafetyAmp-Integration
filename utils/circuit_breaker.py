...
@circuit(
    failure_threshold=5, recovery_timeout=300, expected_exception=requests.HTTPError
)
...
class SmartRateLimiter:
    ...
    def on_429_error(self):
        ...
        if self.adaptive:
            ...
            logger.warning(
                f"Adapting rate limit to {self._current_limit} calls/second due to 429 error"
            )
